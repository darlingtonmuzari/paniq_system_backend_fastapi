"""
Mobile user management API endpoints with attestation
...
async def register_user(
    ...
    """
    Register a new user (mobile endpoint with attestation)
    """
...
async def request_phone_verification(
    ...
    """
    Request phone number verification OTP (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def verify_phone_otp(
    ...
    """
    Verify phone number with OTP (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def get_user_profile(
    ...
    """
    Get current user profile (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def update_user_profile(
    ...
    """
    Update user profile (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def create_user_group(
    ...
    """
    Create a new user group (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def get_user_groups(
    ...
    """
    Get all groups for current user (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def add_mobile_number_to_group(
    ...
    """
    Add mobile number to group (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def get_group_mobile_numbers(
    ...
    """
    Get mobile numbers for a group (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def remove_mobile_number_from_group(
    ...
    """
    Remove mobile number from group (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def delete_user_group(
    ...
    """
    Delete a user group (mobile endpoint with attestation)
    """
    service = UserService(db)
...
async def get_user_statistics(
    ...
    """
    Get user statistics (mobile endpoint with attestation)
    """
    service = UserService(db)
    
    try:
        stats = await service.get_user_statistics(current_user.user_id)
        return stats
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
