#!/usr/bin/env python3
"""
Test application submission with a fresh firm status
"""
import asyncio
import sys
import os
...
async def test_fresh_submission():
    """Reset firm status and test submission"""
    
    print("🔄 Testing fresh application submission...")
    ...
    async for db in get_db():
        try:
            ...
            # Reset firm status to draft
            print("🔄 Resetting firm status to 'draft'...")
            ...
            print("🗑️ Cleaning up existing applications...")
            await db.execute(text("""
            ...
            print("🚀 Attempting fresh application submission...")
...
if __name__ == "__main__":
    success = asyncio.run(test_fresh_submission())
    
    if success:
        print("\n🎉 Fresh application submission successful!")
        print("💡 The document upload and application submission flow is working correctly.")
    else:
        print("\n❌ Fresh application submission failed.")
